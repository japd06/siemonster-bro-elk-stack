...
$config['elasticsearch'] = [
   ...
   # Configuration for the dockerbeat index that 411 queries.
    ...
    # Generic index for all bro logs.
    'bro' => [
        'hosts' => ['http://es-client:9200'],
        'index_hosts' => [],
        'ssl_cert' => null,
    ...
    # Additional indexes for the bro subtypes
    'bro-conn' => [
        'hosts' => ['http://es-client:9200'],
        'index_hosts' => [],
        'ssl_cert' => null,
        'index' => '[bro-conn-]Y.m.d',
        'date_based' => true,
        'date_field' => '@timestamp',
        'src_url' => null,
    ],
